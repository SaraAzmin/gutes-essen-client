        ...
        <SectionTitle subHeading="check it out" heading="Featured Item" ></SectionTitle>
            <div className="md:flex justify-center items-center pb-20 pt-12 px-36">
                ...
                <div className="md:ml-10">
                    <p className="mb-5 font-medium">Aug 20, 2024</p>
                    <p className="uppercase mb-5 font-semibold">Where can i get some?</p>
                    ...
                    <button className="btn btn-outline border border-b-4 mt-4 text-white text-lg">Order Now</button>
                </div>
            </div>
        </div> 
        </div>
